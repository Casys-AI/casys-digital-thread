...
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Verified now**      | One native read-only project cockpit from first intent onward. Schema-`3.0` project revisions own guided questions, sourced answers, proposed and canonical brief truth, the reviewed path, runs and evidence references. The default MCP surface creates the project immediately and exposes no separate Discovery or handoff tools. Signed MRTR binds an accepted host response to the exact brief or decision request. `baseline.from-approved-brief@1` records documentary r1; this is provenance, not technical proof. The older SysON seed and guarded inspection-drone architecture executors remain demonstrated against historical schema-`2.0` lineage while their V3 brief-binding migration is still pending. Exact SysON, CAD, Modelica, ERPNext, and CalculiX evidence remain demonstrated separately by the CM-01 reference path, including one approved DripTray mechanical proof loop. |
...
The historical `architecture.author-inspection-drone@1` continuation requires the exact
r2 seed, an empty root, and the same approved discovery's explicit
