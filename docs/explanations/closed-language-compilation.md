...
| --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| Build123d | 473 public names of the pinned 0.11.1 + the finite Python host core                                                                                                          | `config/build123d-api/inventory-0.11.1.json`, regenerated by introspecting the sandbox image                         | analyzer 1.5.0 (~18 calls + placements + narrow selectors); full-coverage plan drafted  |
...
| Modelica  | The Modelica Language Specification grammar + the versioned MSL classes shipped in the pinned OpenModelica image                                                             | Kit self-declaration (Modelica models declare their own parameters — introspect, never invent) + image introspection | `modelica-closed-subset-v1` + the qualified linear thermal kit                          |
