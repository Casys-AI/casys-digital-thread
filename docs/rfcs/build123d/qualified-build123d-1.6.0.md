...
| `docs/reference/runtime/workspace-map.md`                                    | analyzer row `1.6.0` and the same qualify clause                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
run `deno fmt` on `docs/reference/runtime/workspace-map.md`: the table is width-aligned, and a
