...
| [Deno Desktop product shell](desktop/deno-desktop-product-shell.md)                                    | `active`      | [workspace map](../reference/runtime/local-runtime-and-ports.md); Lots 1–4 are implemented, while native distribution proof remains macOS-only                                                                                                   |
...
| [mechanism verification](mechanism/README.md)                                                           | `implemented` | [prescribed kinematics](../reference/domains/mechanism/prescribed-kinematics.md) for the bounded vertical; [assembly integrity](../reference/domains/cad/assembly-integrity.md) remains separate. Catalogue Chrono dispatch stays `unqualified` as a repository baseline; this host's matching emulation overlay is on [local runtime and ports](../reference/runtime/local-runtime-and-ports.md). |
