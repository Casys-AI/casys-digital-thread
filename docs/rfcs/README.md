...
| [mechanism verification](mechanism/README.md)                                                           | `deferred`    | [static assembly basis](../reference/domains/cad/static-assembly-basis.md) and [assembly integrity](../reference/domains/cad/assembly-integrity.md). The Chrono page is a parked preference, not a work brief. |
