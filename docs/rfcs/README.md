...
| [acpx 0.13.1 elicitation alignment](desktop/acpx-0.13.1-elicitation-alignment.md)                      | `implemented` | [current product direction](../explanations/product/product-direction.md); Desktop chat consumption remains deferred                                                   |
| [Deno Desktop product shell](desktop/deno-desktop-product-shell.md)                                    | `active`      | [workspace map](../reference/runtime/workspace-map.md); Lots 1–2 are implemented, while Workbench and Chat Host remain deferred                                        |
| [embedded acpx chat](desktop/embedded-acpx-chat.md)                                                    | `active`      | [current product direction](../explanations/product/product-direction.md); proposed and not implemented                                                                |
| [private cross-project sensitivity reuse](sensitivity/private-cross-project-experience-reuse.md)       | `active`      | [current sensitivity domain reference](../reference/domains/sensitivity/README.md); the RFC target is not implemented                                                  |
