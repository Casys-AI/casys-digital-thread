...
| Workbench projection                                                         | Generic read-only Workbench exists                                                                                                                                                                                                                                                                                             | AL01 project r34 and Thread r4 projected with separate branch brief items                                                                 | GET and SSE observed `aligned` on 2026-08-22               | UI is not proof                                              | Workbench must not receive commands                                 |
