...
| `geometry-module-draft-capture/1.0`                       | Review-only module draft: input-bundle fingerprint, isolated receipt, reopened child STEP identities, produced STEP+GLB | Child source text, a generated program, a provider call, or Thread evidence |
