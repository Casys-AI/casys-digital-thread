...
| Tool                                                      | Writes             | Grant                                                                                                                                                                                                                                                                                                                                                         |
| --------------------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `project_technical_source_capture`                        | Draft CAS          | `projectId` + `workspaceRevision` + `attachmentId` + `attachmentRevision`. Review: `parser` + `levers` + opaque locator/3.0. Pass `result.reference` only. `fileId`/`fileRevision`/`profileId` refused                                                                                                                                                                                                                 |
