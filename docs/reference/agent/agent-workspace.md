...
| `project_product_source_closure`                   | Read      | Technical dependency closure of one source **after** it is an exact Thread/admission attachment. Then use `project_source_file_read` / `project_source_tree`.                                                                                                                                                                                   |
