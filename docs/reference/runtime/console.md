...
| `project_admitted_spice_run_review`         | Read           | MRTR parameters for `simulate.run-admitted-spice@1`. No netlist, image, args, path, or observations                         |
...
[the native Workbench preview how-to](../../how-to/cockpit/preview-native-workbench.md#follow-the-agent-selected-workspace).
