...
| `http://127.0.0.1:3023/mcp`  | `mcp-spice`                 | Digest-pinned 0.5.1 ngspice netlist admission, OP, reduced transients, and bounded DC sweeps; maintainer D2 probe only, never the admitted product path                                  |
