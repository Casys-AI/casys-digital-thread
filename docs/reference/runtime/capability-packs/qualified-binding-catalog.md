...
| `geometry.execute-admitted-source@1`                | `build123d-execute-admitted-source-preparation@1.0.0` · preparation · qualified | `casys.build123d-isolated-worker`        | Stages exact admitted-source execution only; remains documentary; does not qualify a downstream solver or product verdict                  |
...
| `mechanics.observe-static-structural-sensitivity@1` | `calculix-http-static-sensitivity@1.0.0` · execution · unqualified              | `casys.mcp-calculix`                     | Factual sensitivity only; repository baseline stays unqualified; an exact host attestation can make this binding effective                 |
