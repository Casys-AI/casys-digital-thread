...
| ---------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| [`.mcp.json`](../../.mcp.json)                                                                                               | Legacy direct-stdio wiring; not part of the stateless 2026-07-28 deployment contract                  | Identifying configuration that must not be used for the current deployment  |
