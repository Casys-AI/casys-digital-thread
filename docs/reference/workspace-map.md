...
| [`src/adapters/engineering-project-store.ts`](../../src/adapters/engineering-project-store.ts)             | Read-only validated project manifest loader                  |
...
| `EngineeringProjectSnapshot` | Versioned project manifest | Read-only intent and workflow projection     |
