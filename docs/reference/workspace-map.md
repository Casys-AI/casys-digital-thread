...
| [`src/adapters/executors/coffee-machine-cm01-v3-oracle-requirements-run-executor.ts`](../../src/adapters/executors/coffee-machine-cm01-v3-oracle-requirements-run-executor.ts) | Server-fixed requirement anchoring, fidelity check, monotony ratchet |
| [`src/adapters/executors/coffee-machine-cm01-v3-sensitivity-run-executor.ts`](../../src/adapters/executors/coffee-machine-cm01-v3-sensitivity-run-executor.ts)                 | Two-run sensitivity study; publishes derivatives, never verdicts     |
