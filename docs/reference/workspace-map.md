...
| Admitted CAD/Modelica microVM pattern | [admitted source isolated execution](admitted-source-isolated-execution.md) |
| Agent tools, operations, grants | [agent workspace](agent-workspace.md) |
| Lookalike pairs | [lookalike traps](lookalike-traps.md) |
...
| `http://127.0.0.1:5175/`     | `deno task preview:cockpit` | Read-only BFF (API/SSE) and frozen single-file cockpit                                                                                                                             |
...
Lookalike traps for agents: [lookalike traps](lookalike-traps.md).
