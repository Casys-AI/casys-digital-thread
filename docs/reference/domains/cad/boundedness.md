...
**needs decision** (see [SysML inventory](../sysml/boundedness.md) for the same legend).
...
| Qualified AST nodes                          | Lezer walk in [`qualified-build123d-source-analyzer.ts`](../../../../src/adapters/cad/source/qualified-build123d-source-analyzer.ts) has no node-count check | Analyzer 1.7.0                                                                                                                                                                                                                                 | **Physical-only** (64 KiB and the token guard) | An explicit node cap would be a product decision; it is not implied by the runtime profile |
...
[`first-party-build123d-execution.ts`](../../../../src/adapters/cad/isolated/first-party-build123d-execution.ts).
CPU and process count remain unattested (see
