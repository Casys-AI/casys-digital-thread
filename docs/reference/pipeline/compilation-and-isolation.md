...
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Admission              | V2 `technical-compilation-input/2.0` / `technical-compilation/2.0`, exact-basis/source readers, content-addressed review draft and provider-free admission seal | The current registered Build123d profile is 3.1.0 over the qualified closed subset with standalone physical comments as non-semantic annotations and direct scalar-leaf workspace-closure lowering; it additionally requires a finite module-level numeric parameter, unique `parameterizes` binding and causal reachability to `result`. Dead or constructor-only dimensions are unresolved. The comment rule is covered through exact canonical and isolated reopens, not a new comment-specific pinned-runtime receipt. There is no legacy-profile reader or compatibility path |
