...
- Authority and lookalikes: [agent workspace](../reference/agent-workspace.md)
- Pipeline:
  [analysis-authority-pipeline](../reference/analysis-authority-pipeline.md#implemented-agent-authored-architecture-sysml-slice)
- SysON insertion path: `model.write-architecture@1` in
  [engineering-project](../reference/engineering-project.md)
