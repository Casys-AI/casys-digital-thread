...
and contract versions appear where exact execution requires them, not as substitutes
for the goal.

Start with [Walk through an engineering project](verify-design/walk-through-an-engineering-project.md)
