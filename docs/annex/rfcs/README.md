...
> **Archive.** Observation / planning status. Non-authoritative. Frozen except
> link fixes. Living docs index: [docs/README.md](../../README.md).

Audience: both · Diátaxis: none · Kind: RFC

A file in `docs/annex/rfcs/` is a **session brief** or a **study** (sometimes rejected). It is
