...
| `&` / `\|`                                                      | `unrecognized_token` — **vivacité**, déjà noté dans `docs/annex/rfcs/build123d/qualified-build123d-1.5.0.md:17-31` |
...
- Frontend : `unresolved` (`build123d-call-not-qualified`, `python-dynamic-attribute`,
  ...
  `docs/annex/rfcs/build123d/qualified-build123d-selector-grammar-study.md:140-161`).
