...
Versions validées par l'utilisateur (dans Dashboard Mockups.dc.html) :
...
Portage Ark UI + Tailwind 4 (Preact) : cockpit-ark-tailwind-preact.html = les 7 vues validées dans un seul prototype navigable (nav 5a, Product déplié en Structure/Requirements/Sourcing, briefing 6b via le menu du header). overview-ark-tailwind-preact.html reste la page Overview seule ; overview-ark-tailwind.html = même page sur React.
