...
> = {
  ...
  "verify.seal-prescribed-kinematics-case@1": fixed("physics"),
  "verify.run-prescribed-kinematics@1": fixed("physics"),
  "verify.seal-prescribed-kinematics-method@1": fixed("physics"),
  "verify.evaluate-prescribed-kinematics@1": fixed("verdicts"),
  "decide.accept-prescribed-kinematics-evaluation@1": fixed("verdicts"),
  "decide.reject-prescribed-kinematics-evaluation@1": fixed("verdicts"),
