...
> = {
  ...
  "compile.seal-admission@1": contextual(
    ["geometry", "physics"],
    "system-model",
  ),
  "compile.capture-corrected-source@1": fixed("physics"),
  ...
  "verify.seal-cross-domain-impact-manifest@1": fixed("verdicts"),
  "analyze.evaluate-cross-domain-impact@1": fixed("verdicts"),
  "decide.accept-cross-domain-impact@1": fixed("verdicts"),
  "analyze.evaluate-mechanical-preservation@1": fixed("verdicts"),
