...
} from "../ports/in/project-architecture-sysml-preview.ts";
...
import { encodeArchitectureSysmlSealParameters } from "../../domain/engineering/architecture-sysml-seal-proposal.ts";
...
} from "../ports/out/architecture-sysml-source-analysis-reader.ts";
