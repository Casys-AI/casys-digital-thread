...
import type { ProjectCorrectedAdmissionReviewResult } from "../ports/in/project-corrected-admission-review.ts";
import type { ProjectCorrectedAdmissionReviewUseCase } from "../ports/in/project-corrected-admission-review.ts";
import type { TechnicalCompilationAdmissionReader } from "../ports/out/technical-compilation-admission-reader.ts";
import type { ProjectTechnicalCompilationPreviewUseCase } from "../ports/in/project-technical-compilation-preview.ts";
import { validateCorrectedSourceCapture } from "../../domain/analysis/corrected-source-capture.ts";
import {
  deepFreeze,
  exactRecord,
  literalValue,
