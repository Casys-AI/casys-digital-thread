...
import type { Build123dExecutionAdmission } from "../../../domain/analysis/build123d-execution-proposal.ts";
import type {
...
import type { TechnicalCompilationDraftReference } from "./technical-compilation-draft-store.ts";
