...
import type { EphemeralExecutionBackendRequest } from "../../application/ports/out/ephemeral-execution-backend.ts";
import type {
...
import { MICROSANDBOX_LOCAL_ISOLATION_CLASS } from "../../domain/analysis/local-isolation-runtime.ts";
