...
import { validateCalculixIsolatedOutput } from "../../domain/analysis/calculix-isolated-execution.ts";
...
import { CALCULIX_MICROSANDBOX_WORKER_CONTRACT } from "../execution-profiles/calculix-static-proof-v1/worker-contract.ts";
import type { ExecuteIsolatedCalculixStaticProof } from "../../application/use-cases/execute-isolated-calculix-static-proof.ts";
import type { CalculixIsolatedExecutionEvidenceStore } from "../../application/ports/out/calculix-isolated-execution-evidence-store.ts";
...
export async function createCalculixIsolatedExecutionComposition(
  ...
  const [
    ...
    import("./microsandbox-ephemeral-execution-backend.ts"),
    import("../wal/file-calculix-isolated-execution-attempt-store.ts"),
    import("../captures/calculix-isolated-execution-evidence.ts"),
    import("../stores/file-engineering-project-run-lease.ts"),
    import("../validators/calculix-isolated-output-batch-inspector.ts"),
    import("../../application/use-cases/execute-isolated-calculix-static-proof.ts"),
  ]);
