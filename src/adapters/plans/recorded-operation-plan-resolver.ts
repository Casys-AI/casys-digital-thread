...
export interface RecordedOperationPlanResolverOptions {
...
export class RecordedOperationPlanResolver implements FeaRecordedRunAdmissionReviewer {
  ...
  constructor(private readonly options: RecordedOperationPlanResolverOptions) {
