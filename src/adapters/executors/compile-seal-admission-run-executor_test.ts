...
import type { TechnicalCompilationBasisResolver } from "../../application/ports/out/technical-compilation-basis-resolver.ts";
...
} from "../../application/ports/out/technical-compilation-draft-store.ts";
import type { TechnicalCompilationProfileCatalogProvider } from "../../application/ports/out/technical-compilation-profile-catalog-provider.ts";
import type { TechnicalCompilationSourceReader } from "../../application/ports/out/technical-compilation-source-reader.ts";
import {
...
import { CaptureBackedTechnicalCompilationSourceReader } from "../compilers/capture-backed-technical-compilation-source-reader.ts";
import {
  INITIAL_TECHNICAL_COMPILATION_PROFILE_CATALOG,
} from "../compilers/fixed-technical-compilation-profile-catalog-provider.ts";
import {
