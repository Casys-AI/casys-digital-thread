...
import { buildConstraintAst } from "../../domain/analysis/proof-case.ts";
import {
  resolveSensitivityBaseJoin,
  VERIFY_EVALUATE_SENSITIVITY_BASE_OPERATION,
} from "../../domain/analysis/sensitivity-base-evaluation.ts";
import {
...
import { parseOracleOutcome } from "../captures/syson-constraint-oracle-outcome.ts";
import {
...
} from "../captures/sensitivity-base-evaluation-capture.ts";
import {
  requireBasis,
  requiredStart,
  requireRun,
