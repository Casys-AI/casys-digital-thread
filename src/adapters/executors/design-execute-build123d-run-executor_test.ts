...
} from "../../application/ports/out/build123d-execution-attempt-store.ts";
import type {
  Build123dExecutionCaptureStore,
  Build123dExecutionDraftStore,
} from "../../application/ports/out/build123d-execution-evidence-store.ts";
...
} from "../../domain/analysis/build123d-execution-evidence.ts";
import {
...
async function createFixture(options: FixtureOptions = {}): Promise<Fixture> {
  ...
  const reviewUseCase = new (await import(
    "../../application/use-cases/prepare-project-build123d-execution-review.ts"
...
class FakeRunner implements IsolatedCodeRunner {
  ...
  async buildReceipt(
    ...
    return await createIsolatedCodeExecutionReceipt({
      request: await (await import("../../domain/analysis/isolated-code-execution.ts"))
...
class FakeDrafts implements Build123dExecutionDraftStore {
  ...
  async save(value: unknown) {
    const draft =
      await (await import("../../domain/analysis/build123d-execution-evidence.ts"))
