...
import { briefSourceIdFor } from "../../domain/analysis/brief-source-analysis-reference.ts";
import type {
...
export { briefSourceIdFor } from "../../domain/analysis/brief-source-analysis-reference.ts";
