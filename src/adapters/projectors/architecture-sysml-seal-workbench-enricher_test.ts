...
import { QUALIFIED_ARCHITECTURE_SYSML_ANALYSIS_PROFILE } from "../analyzers/qualified-architecture-sysml-analyzer.ts";
import { FileByteStore } from "../captures/file-byte-store.ts";
import { fileArchitectureSysmlSealCaptureReader } from "../captures/file-architecture-sysml-seal-capture-reader.ts";
import { createArchitectureSysmlSourceAnalysisCaptureService } from "../compilers/architecture-sysml-source-analysis-composition.ts";
import {
