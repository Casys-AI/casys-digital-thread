...
import type { TechnicalCompilationBasisResolutionRequest } from "../../application/ports/out/technical-compilation-basis-resolver.ts";
import {
  deterministicJson,
  sha256Fingerprint,
...
import { ARCHITECTURE_CAPTURE_SCHEMA } from "./architecture-capture.ts";
import {
