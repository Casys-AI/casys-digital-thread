...
import { MCP_CHRONO_035_IMAGE_REFERENCE } from "./first-party-capability-runtime-identities.ts";
...
> {
  ...
  const expectedDigest = MCP_CHRONO_035_IMAGE_REFERENCE.slice(
  ...
  if (
    ...
    unit.version !== "0.3.5" || material.id !== "mcp-chrono-image" ||
    material.imageReference !== MCP_CHRONO_035_IMAGE_REFERENCE ||
