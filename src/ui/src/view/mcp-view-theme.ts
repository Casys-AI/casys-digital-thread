/**
 * Local copy of `@casys/mcp-view@0.7.1` `src/theme.js`.
 *
 * Copied verbatim during the React migration: the published theme is only
 * exported through Preact-importing entry points, which would pull Preact
 * back into the React bundle. The shadcn redesign replaces this stylesheet
 * lot by lot, after which this file disappears.
 */
