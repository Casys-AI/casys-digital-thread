 ...
 * recorded run binds that document plus the exact STEP named inside it. The
 * parser is the only authority on the envelope shape: the plan resolver and
 * the recorded-run review must not invent a second reading.
 */
