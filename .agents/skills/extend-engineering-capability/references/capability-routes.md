...
| Nested CAD modules     | Qualify manual composition of a canonical child module under one parent module, without ancestor auto-rebuild | [Qualify nested CAD modules](../../../../docs/how-to/extend/qualify-nested-cad-modules.md)               |
...
| Requirements recapture | Qualify read-only recapture of unchanged native scalar requirements against a newer exact architecture        | [Qualify requirements recapture](../../../../docs/how-to/extend/qualify-requirements-recapture.md)       |
