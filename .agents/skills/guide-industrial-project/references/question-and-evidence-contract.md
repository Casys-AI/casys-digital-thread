...
For compliance work, retain separately: authority, jurisdiction, instrument or
standard identifier, revision/effective date, source URI, applicability rationale,
means of compliance, expected evidence, status, and reviewer. Do not flatten multiple
countries into a fictional global requirement.
